...
function numClick(content) {
    ...
    if ($(window).width() < 361) {
        if (currentNumber.text().length > 7) currentNumber.css("font-size", "2.5rem");
        else currentNumber.css("font-size", "3rem");
    } else if ($(window).width() < 431) {
        if (currentNumber.text().length > 7) currentNumber.css("font-size", "3.5rem");
        else currentNumber.css("font-size", "4rem");
    } else {
    ...
    if (content === ".") {
        ...
        if (currentNumber.text().includes(".")) currentNumber.text(currentNumber.text() + content);
        else currentNumber.text(+(currentNumber.text() + content));
    }
...
function resetClick() {
    ...
    if ($(window).width() < 361) currentNumber.css("font-size", "3rem");
    else if ($(window).width() < 431) currentNumber.css("font-size", "4rem");
    else currentNumber.css("font-size", "5rem");
}
